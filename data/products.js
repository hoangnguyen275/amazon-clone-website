...
export let products = await loadProductsFetch() || [];
...
export async function loadProductsFetch(){
  try {
    ...
    return productData.map((productDetails) => {
...
export const products = [
  ...
  {
    id: "8a77343c-b256-6cb1-06a2-fb529f3bc36e",
  ...
  {
    id: "498c62a2-c584-a7f3-7742-973c47e2785a",
